  ...
  return (
    <div className={`grid grid-cols-[2fr_1fr_1fr_1.5fr_auto] gap-4 px-5 py-4 items-center transition-colors
      ...
      <div className="flex gap-2 justify-end">
        <button className="btn-outline text-[9px] px-3 py-1.5" onClick={onEdit}>EDITAR</button>
        <button
        ...
        <div>
          ...
          {!isLoading && (
            <p className="font-mono text-xs text-[var(--text-muted)] mt-1 tracking-widest">
              {services.length} serveis · {activeCount} actius
              {inactiveCount > 0 && ` · ${inactiveCount} inactius`}
            </p>
          )}
        </div>
